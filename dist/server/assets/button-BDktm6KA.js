import { r as reactExports, U as jsxRuntimeExports, $ as React } from "./worker-entry-BDTLecxS.js";
...
const logoSrc = "/assets/ggcart-logo-B_h0dROn.jpg";
function Logo({ className = "h-8 w-8" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-xl bg-gradient-to-br from-primary/40 to-accent/40 blur-md opacity-70" }),
